/*
  Title:    Cryologger - Glacier Velocity Measurement System
  Date:     June 26, 2018
  Author:   Adam Garbo

  Components:
  - Adafruit Trinket Pro 5V
  - Adafruit SOIC-16 SMT Breakout PCB + DS3231SN RTC
  - Adafruit 12mm Coin Cell Breakout Board
  - ComNav K706 GNSS receiver
  - ComNav AT330 GNSS antenna

  Comments:
  - Glacier velocity measurement system deployed on the
  Milne Glacier, Ellesmere Island, Nunavut, Canada in the
  summer of 2018.
*/
...
const float     minVoltage          = 10.0;         // Minimum measured battery voltage required to begin recording of GNSS observations
